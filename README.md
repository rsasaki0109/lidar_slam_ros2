...
gsplat (Apache-2.0). **[Spin one in your browser →](https://rsasaki0109.github.io/lidar_slam_ros2/3dgs-viewer.html)**
(no install, no GPU).
...
Interactive WebGL viewer + the `.ply`→`.splat` exporter: [docs/3dgs-viewer.md](docs/3dgs-viewer.md).
