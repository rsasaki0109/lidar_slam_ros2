...
- IMU topic: `/imu/imu`
- RKO-LIO parameters: [lidarslam/param/rko_lio_ntu_viral.yaml](/media/sasaki/aiueo/ai_coding_ws/ros2/lidarslam/param/rko_lio_ntu_viral.yaml)
