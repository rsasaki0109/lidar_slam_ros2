...
The
[installed build-provenance validation](../evidence/installed-build-provenance-2026-07-28.md)
closed the missing Git revision found in installed source and container runs.
Clean Humble Git-discovery and Jazzy Docker-override installs both recorded
and consumed the exact source commit.

The
[Humble clean-source first-map validation](../evidence/source-first-map-humble-2026-07-28.md)
then exercised that contract through the complete installed CLI: fresh
recursive clone, rosdep, all-package release build, doctor, public MID-360 map
generation and an independent 8/8 verifier pass. Its final manifest recorded
the exact clean source revision. This is maintainer evidence, not an
