...
The maintainer-operated
[source-workspace first-map trial](../evidence/source-first-map-2026-07-28.md)
found the missing fresh apt-index step, then completed a clean Jazzy recursive
build and verified map. It also does not count toward the independent-user
reports.
...
External-adoption status: **0 / 3 accepted validations**. Intake, qualification
criteria and the auditable evidence table are published in the
[independent first-map validation ledger](../evidence/independent-first-map-validations.md).
The versioned answers template, privacy-bounded collector, JSON schema and CI
fixtures are ready for external use. Maintainer-operated runs do not count
toward this gate.
