...
> passed, while its first public post-integration artifact remains)**.
> This roadmap
...
passed all ten checks. Its first passing public post-integration artifact and
the first tagged publication of the new rollback assets remain open, so Phase
