...
Timestamp reversal, scheduled live exhaustion and migration tooling remain
open, so Phase 3 remains in progress. Digest-pinned rollback tooling and the
operator runbook are implemented; the tracked ledger remains unassigned until
the first qualifying release is reviewed and promoted.
