...
Order 1 reached `LOCAL_IMPLEMENTATION_PASS_PUBLICATION_PENDING` at `a2368c4`.
The [evidence record](../evidence/voxel-grid-overflow-safety-2026-08-11.md)
passes the bounded fixture, valid-output parity, and complete scanmatcher CTest
sets on Humble/PCL 1.12 and Jazzy/PCL 1.14. G0 remains open: the revision is
local-only, and the public component-level unsafe-then-safe execution and
carrying release are not yet available.
