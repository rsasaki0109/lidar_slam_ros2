...
success. A real synthetic subprocess probe returns 130 and leaves no child PID.
Forty-two sensor-setup regressions, exact S3 lifecycle 77 and edit/merge 15, all
48 lower map-runner regressions, plus 42 docs/product, 25 support/installed, 21
option-contract, and 331 broad S6 regressions pass with changed-code
`ament_flake8`, strict MkDocs, and plan validation. This is not a real
interrupted ROS map, clean-host timing result, paired GLIM observation, or
parity claim. No map, upload, network access, issue, or GitHub write occurs.
