...
| S3 map lifecycle | 25 | setup, history, compare, edit, merge, and support preserve provenance and receipts; interactive calibration review continues through one fail-closed prompt while non-interactive use retains an exact rerun command | focused local review |
