...
>
> Planned follow-up inventory: 327 paths; SHA-256
> `51cf5a5d500ec14fd48a4b11f812c6dc4aec98c55ca9a8e787dee849a25358c5`
>
...
4. exact 327-path coverage with the fixed inventory digest;
...
| Check | Result |
| --- | --- |
| exact Git-derived plan check | `PLAN_VALID_LOCAL_ONLY`; 327 paths, 7 slices, no remote mutation |
