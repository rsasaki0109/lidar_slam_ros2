...
| S3 map lifecycle | 25 | setup, history, compare, edit, merge, and support preserve provenance and receipts; interactive calibration review continues through one fail-closed prompt, confirmed live starts skip repeated setup detail before durable progress, and terminal success is one evidence-backed completion card with one `Next` action | focused local review |
