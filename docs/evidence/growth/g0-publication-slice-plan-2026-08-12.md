...
| clean candidate release bundle | exact-head reproducibility rehearsal passes at clean RTK-SLAM evidence carrier `554e41b`; two byte-identical and reverified bundles each contain 263 manifest files, total 11,938,413 archive bytes, and have SHA-256 `1287d8af5627894aa37759ed031109d7204eca3608b5cf2ab499fdfed3a4cb06`; this supersedes the 261-file S6 result as local evidence only |
| complete maintained Python gate | RTK-SLAM acquisition synchronization: source-explicit graph 1,462 passed / 13 skipped / 11 existing ImageIO warnings; source-explicit lidarslam 1,040 passed; 2,502 total; strict MkDocs and changed-file Jazzy `ament_flake8` pass; latest public `662ac8f` Actions pass 10 successful / 4 intentional skips / 0 failures / 0 pending; the post-acquisition bundle rehearsal passes at exact clean carrier `554e41b` without granting tag or publication authority |
