...
| Complete maintained product gate | NTU attached-storage validation carrier `b01b251…`: source-explicit graph 1,477 passed / 13 skipped / 11 existing ImageIO warnings; source-explicit lidarslam 1,040 passed; 2,517 total; strict MkDocs and changed-file Jazzy `ament_flake8` pass; latest public `39b5e38…` Actions pass 10 successful / 4 intentional skips / 0 failures / 0 pending; the canonical two-build bundle rehearsal passes with 267 manifest files, 11,959,011 archive bytes, and SHA-256 `f963391bf76f67e27828bf0c8eadada484ac8b8b9481e5f904fcec72e1c64bad` | NTU and RTK acquisition plus attached-storage recovery are fully test-, review-, and artifact-gated locally; archived bounded entrypoints execute; the bundle is not a published release asset, and every later candidate must rerun rather than reuse its checksum |
...
| Publication slice plan | `PLAN_VALID_LOCAL_ONLY`; 319 paths / 7 slices from frozen baseline `3ed632e…`; the exact carrier's Git-derived follow-up count comes from `check_publication_slice_plan.py`; inventory SHA-256 `fa6cd94d350c7ebf68c26ba8bb2c035b344543c374ea5123c367c4de4d8a437e` | the Odometry/TF bag preflight belongs to S2/S6, while NTU and RTK acquisition remain in S5; every displayed verification group is self-contained for an ordinary terminal; exact coverage and the digest add no mount, GitHub, release, posting, or community authority |
