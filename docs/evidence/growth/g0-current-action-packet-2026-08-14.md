...
| Complete maintained product gate | attached-storage evidence carrier `3a38154e…`: source-explicit graph 1,466 passed / 13 skipped / 11 existing ImageIO warnings; source-explicit lidarslam 1,040 passed; 2,506 total; strict MkDocs and changed-file Jazzy `ament_flake8` pass; latest public `bd01328…` Actions pass 10 successful / 4 intentional skips / 0 failures / 0 pending; the canonical two-build bundle rehearsal passes with 264 manifest files, 11,948,788 archive bytes, and SHA-256 `46b20d1eecaf6ab665c17816db42e937e9cb50c88a8dc4340beda4f2e670cf27` | acquisition and attached-storage recovery are fully test-, review-, and artifact-gated locally; the bundle is not a published release asset, and every later candidate must rerun rather than reuse its checksum |
