...
| Publication slice plan | `PLAN_VALID_LOCAL_ONLY`; 299 paths / 7 slices from frozen baseline `3ed632e…`; the exact carrier's Git-derived follow-up count comes from `check_publication_slice_plan.py`; inventory SHA-256 `ed899dc8f510e200709d6a9a81430b10be523ae2107110de2bea31b44670f359` | the twelve claim-bounded media paths belong to S6; exact coverage and the new digest add no GitHub, release, posting, or community authority |
