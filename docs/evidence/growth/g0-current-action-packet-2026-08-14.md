...
| Publication slice plan | `PLAN_VALID_LOCAL_ONLY`; 310 paths / 7 slices from frozen baseline `3ed632e…`; the exact carrier's Git-derived follow-up count comes from `check_publication_slice_plan.py`; inventory SHA-256 `9a025bd9d270f1abf812b8d79b9b34ea6395102a3df8d868201311c1779daf9b` | the bounded support handoff and compressed-bag playback paths belong to S6; every displayed verification group is self-contained for an ordinary terminal; exact coverage and the digest add no GitHub, release, posting, or community authority |
