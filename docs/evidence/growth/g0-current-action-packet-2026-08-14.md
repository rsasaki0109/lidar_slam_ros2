...
| Publication slice plan | `PLAN_VALID_LOCAL_ONLY`; 224 paths / 7 slices, clean at the refreshed tip | local inventory is complete and cannot authorize a GitHub write |
