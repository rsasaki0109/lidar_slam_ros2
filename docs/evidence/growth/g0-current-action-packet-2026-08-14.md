...
| Publication slice plan | `PLAN_VALID_LOCAL_ONLY`; 317 paths / 7 slices from frozen baseline `3ed632e…`; the exact carrier's Git-derived follow-up count comes from `check_publication_slice_plan.py`; inventory SHA-256 `5e1a9783bd891502d1ea547d164b6cf562f3c56667796cd9463067007d368f84` | the NTU and RTK acquisition implementations, regressions, and evidence paths belong to S5; every displayed verification group is self-contained for an ordinary terminal; exact coverage and the digest add no mount, GitHub, release, posting, or community authority |
