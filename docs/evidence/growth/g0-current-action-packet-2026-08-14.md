...
| Complete maintained product gate | RTK-SLAM acquisition synchronization: source-explicit graph 1,462 passed / 13 skipped / 11 existing ImageIO warnings; source-explicit lidarslam 1,040 passed; 2,502 total; strict MkDocs and changed-file Jazzy `ament_flake8` pass; latest public `662ac8f…` Actions pass 10 successful / 4 intentional skips / 0 failures / 0 pending | the new acquisition paths are fully test- and review-sliced, but candidate-bundle reproducibility has not been rerun after those paths and remains an exact-final-head release gate |
